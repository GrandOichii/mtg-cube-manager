...
def message_box(parent: 'UIElements.Window', message: str, choices: list=['Ok'], ypos: int=-1, xpos: int=-1, height: int=-1, width: int=-1, additional_lines: list=[], border_color: str='normal'):
